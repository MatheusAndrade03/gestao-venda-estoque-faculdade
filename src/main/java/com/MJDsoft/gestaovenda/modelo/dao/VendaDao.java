 ...
 */
package com.MJDsoft.gestaovenda.modelo.dao;
...
public class VendaDao {
    ...
    private void editarVendaItem(VendaDetalhes vendaDetalhes) {
        ...
        try {
            ...
            String mensagem = resultado == 1 ? "Venda Detalhes editado com sucesso." : "Nao foi possivel editar Venda detalhes";
            System.out.println(mensagem);
        } catch (SQLException e) {
            System.out.println(String.format("Error: %s", e.getMessage()));
        }
...
//                return getUsuario(result);
    ...
    public String deleteVendaPeloId(Long id) {
        ...
        try {
            ...
            return resultado == 1 ? "Venda apagada com sucesso" : "Nao foi possivel apagar";
